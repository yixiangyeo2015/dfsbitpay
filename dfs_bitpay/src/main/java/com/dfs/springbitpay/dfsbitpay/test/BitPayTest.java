package com.dfs.springbitpay.dfsbitpay.test;
...
public class BitPayTest {
	...
	public static void setUpOneTime() throws InterruptedException, IOException, BitPayException, URISyntaxException {
        ...
        myKeyFile = new URI("file:///E:/School/dfs/java-bitpay-client-master/java-bitpay-client-master/tmp/bitpay_private.key"); //if file exists, it will not overwrite
